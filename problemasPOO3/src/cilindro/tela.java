...
public class tela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Calcular área total, area lateral e volume");
    ...
    private void btn_calcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_calcularActionPerformed
        try{
        Cilindro cilindroAtual = new Cilindro();

        cilindroAtual.setAltura(Float.parseFloat(tField_altura.getText()));
        cilindroAtual.setRaio(Float.parseFloat(tField_raio.getText()));

        String saida = "DADOS DO CILÍNDRO\n";
        saida += "Altura: " + cilindroAtual.getAltura() + "\n";
        saida += "Raio: " + cilindroAtual.getRaio()+ "\n";
        saida += "Área Lateral: " + cilindroAtual.calculaAreaLateral()+ "\n";
        saida += "Área total: " + cilindroAtual.calculaAreaTotal()+ "\n";
        saida += "Volume: " + cilindroAtual.calculaVolume() + "\n";
